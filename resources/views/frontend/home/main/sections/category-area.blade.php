...
<section class="categories-area-wrapp">
    <div class="container">
        <div class="home-abt-con-inn categories-head-box">
            <h5><i class="fas fa-star-of-life"></i>{{ __('Trending Categories') }}</h5>
            ...
            @foreach ($trendingCategories as $category)
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="category-box">
                        ...
                        <p>{{ \Illuminate\Support\Str::limit(strip_tags($category?->description), 200) }}
                        </p>
                    </div>
                </div>
            @endforeach
