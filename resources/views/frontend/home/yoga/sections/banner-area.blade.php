            ...
            <div class="row aos-init aos-animate" data-aos="fade-up">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-md-left text-center">
                    <div class="banner-section-content">
                        ...
                        <h1 data-aos="fade-up" class="aos-init aos-animate">Start Healing Your Mind, <span class="ityped">Body &amp; So</span><span class="ityped-cursor">|</span></h1>
                        <p data-aos="fade-right" class="aos-init">Duis aute irure dolor in reprehenderit in volurate velit cillum nulla pariatur nostrud exercitation.</p>
                        <div class="btn_wrapper aos-init" data-aos="fade-up">
