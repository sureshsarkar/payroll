...
<head>
    ...
    <meta name="description" content="{{ Cache::get('setting')?->meta_description ?? Cache::get('setting')?->app_name }}">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="course-id" content="{{ @$course->id }}">
    <meta name="lesson-id" content="">
    <meta name="question-id" content="">
    <meta name="main-base-url" content="{{ url('/') }}">
...
<body>
    ...
    <script>
        ...
        var quiz_st_des_txt = "{{ __('Please go to quiz page for more information') }}";
