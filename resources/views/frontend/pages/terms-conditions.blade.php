...
@section('meta_title', $seo_setting['terms_and_conditions']['seo_title'])
@section('meta_description', $seo_setting['terms_and_conditions']['seo_description'])
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="home-abt-con">
                        <div class="home-abt-con-inn">
                            {!! clean($aboutSection?->content?->terms_and_conditions_page_description) !!}
