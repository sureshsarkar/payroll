...
@section('dashboard-contents')
    ...
    <div class="dashboard__content-wrap">
        <div class="dashboard__content-title d-flex flex-wrap justify-content-between">
            <h4 class="title">{{ __('Edit Coach Staff Permission') }}</h4>
            <a href="{{ route('instructor.coach-staff-permission.index') }}" class="btn btn-primary btn-hight-basic">Go Back</a>
        </div>
                ...
                <div class="invoice-print">
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('instructor.coach-staff-permission.update',$data->id) }}" method="POST">
                                 @csrf
                                 @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control permission_name"
                                                placeholder="Permission Name" value="{{$data->name }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" value="{{$data->slug }}" class="form-control permission_slug"
