...
@php
    ...
    $cmds = $isCoach ? [
        ['Dashboard',          'Home',          route('instructor.dashboard'),                'fa-home'],
        ['My Courses',         'Manage courses',route('instructor.courses.index'),            'fa-graduation-cap'],
        ['New Course',         'Create',        route('instructor.courses.create'),           'fa-plus'],
        ['Live Classes',       'Schedule',      route('instructor.live-classes.index'),       'fa-video'],
        ['Course Batches',     'Cohorts',       url('instructor/course-batches'),             'fa-calendar'],
        ['Lesson Q&A',         'Inbox',         route('instructor.lesson-questions.index'),   'fa-question-circle'],
        ['Sales / Orders',     'My sells',      route('instructor.my-sells.index'),           'fa-shopping-cart'],
        ['Coach Students',     'Students',      route('instructor.my-students.index'),        'fa-users'],
        ['Coach Staff',        'Staff',         route('instructor.coach-staff.index'),        'fa-user-group'],
        ['Staff Roles',        'Roles',         route('instructor.coach-staff-role.index'),   'fa-shield'],
        ['Announcements',      'Broadcast',     route('instructor.announcements.index'),      'fa-bullhorn'],
        ['Website Builder',    'Landing page',  route('instructor.website-builder.index'),    'fa-window-maximize'],
        ['Landing Enquiries',  'Leads',         route('instructor.landing-page-enquiry.index'),'fa-envelope'],
        ['Payouts',            'Withdraw',      route('instructor.payout.index'),             'fa-money-bill'],
        ['Subscription',       'My plan',       route('instructor.subscription-histories.index'),'fa-crown'],
        ...
        ['Dashboard',          'Home',          route('student.dashboard'),                   'fa-home'],
        ['Browse Courses',     'Public',        route('courses'),                             'fa-graduation-cap'],
        ['Enrolled Courses',   'My learning',   route('student.enrolled-courses'),            'fa-book-open'],
        ['Live Classes',       'Schedule',      route('student.live-classes.index'),          'fa-video'],
        ['My Orders',          'Purchase history', route('student.orders.index'),             'fa-receipt'],
        ['My Reviews',         'Ratings',       route('student.reviews.index'),               'fa-star'],
        ['Quiz Attempts',      'Results',       route('student.quiz-attempts'),               'fa-list-check'],
        ['Wishlist',           'Saved',         route('student.wishlist'),                    'fa-heart'],
        ['Cart',               'Checkout',      route('cart'),                                'fa-shopping-cart'],
