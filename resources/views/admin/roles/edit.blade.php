                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form role="form" action="{{ route('admin.role.update', $role->id) }}"
                                            ...
                                            @csrf
                                            <div class="card-body">
                                                {{-- M7 fix (2026-05-12) — was for="name" → id="role_name"
                                                     (mismatch) and for="permission" → nothing. Mirrored
                                                     the create-form fix. --}}
                                                <div class="form-group">
                                                    <label for="role_name">{{ __('Name') }} <span class="text-danger">*</span></label>
                                                    <input value="{{ $role->name }}" name="name" type="text"
                                                        class="form-control @error('name') is-invalid @enderror"
                                                        id="role_name" placeholder="{{ __('Enter name') }}" required>
                                                    @error('name')
                                                ...
                                                <div class="form-group">
                                                    <label id="permissions-heading">{{ __('Permission') }}</label>
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <label for="permission_all"
                                                            class="custom-control-label permission_all">{{ __('All Permissions') }}</label>
                                                    </div>
                                                    <hr>
