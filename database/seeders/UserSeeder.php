...
class UserSeeder extends Seeder
{
    ...
    {
        // F39 (audit 2026-06-26) — HARD GUARD. This seeder TRUNCATES the live
        // users table and creates known-password ('1234') accounts. Running it on
        // a populated multi-tenant DB would wipe every coach + student and plant
        // backdoor logins. Refuse to run outside local/testing.
        if (! app()->environment(['local', 'testing'])) {
            \Log::warning('UserSeeder blocked: destructive demo seeder refused outside local/testing.');
            if (app()->runningInConsole()) {
                $this->command?->warn('UserSeeder skipped — destructive demo seeder only runs in local/testing.');
            }
            return;
        }
