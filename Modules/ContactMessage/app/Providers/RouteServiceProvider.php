...
namespace Modules\ContactMessage\app\Providers;
...
{
    protected string $moduleName      = 'ContactMessage';
    protected string $moduleNamespace = 'Modules\ContactMessage\app\Http\Controllers';
}
