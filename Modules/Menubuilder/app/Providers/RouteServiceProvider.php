...
namespace Modules\Menubuilder\app\Providers;
...
{
    protected string $moduleName      = 'Menubuilder';
    protected string $moduleNamespace = 'Modules\Menubuilder\app\Http\Controllers';
}
