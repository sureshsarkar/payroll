...
namespace Modules\GlobalSetting\app\Providers;
...
{
    protected string $moduleName      = 'GlobalSetting';
    protected string $moduleNamespace = 'Modules\GlobalSetting\app\Http\Controllers';
}
