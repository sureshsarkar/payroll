...
namespace Modules\CertificateBuilder\app\Providers;
...
{
    protected string $moduleName      = 'CertificateBuilder';
    protected string $moduleNamespace = 'Modules\CertificateBuilder\app\Http\Controllers';
}
