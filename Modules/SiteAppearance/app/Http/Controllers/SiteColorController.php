...
class SiteColorController extends Controller
{
    ...
    {
        // FT-IDOR-6 fix (2026-05-27) — no permission gate.
        // SiteColorController controls global site theme colors but
        // was the only controller in the SiteAppearance module without
        // permission checks. Peer controllers (SiteAppearanceController,
        // SectionSettingController) gate on `appearance.management`;
        // match the convention here.
    ...
    {
        // FT-IDOR-6 fix (2026-05-27) — see index() comment.
        checkAdminHasPermissionAndThrowException('appearance.management');
