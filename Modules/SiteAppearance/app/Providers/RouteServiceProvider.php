...
namespace Modules\SiteAppearance\app\Providers;
...
{
    protected string $moduleName      = 'SiteAppearance';
    protected string $moduleNamespace = 'Modules\SiteAppearance\app\Http\Controllers';
}
