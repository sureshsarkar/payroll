...
<div class="pv">
    ...
    <div class="pv-card"><div class="h"><i class="fas fa-user-plus" style="color:var(--pv-brand)"></i> Employee information</div><div class="b"><form method="POST" action="{{ route('hr.employees.store') }}">@csrf
        ...
        </div><div style="margin-top:18px"><button class="pv-btn g"><i class="fas fa-plus"></i> Create employee</button><span class="pv-mut2" style="margin-left:10px">A temporary password is generated and shown once.</span></div>
    </form></div></div>
</div>
@endsection
