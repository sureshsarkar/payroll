...
namespace Modules\InstructorRequest\app\Providers;
...
{
    protected string $moduleName      = 'InstructorRequest';
    protected string $moduleNamespace = 'Modules\InstructorRequest\app\Http\Controllers';
}
