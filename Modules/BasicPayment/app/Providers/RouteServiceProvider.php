...
namespace Modules\BasicPayment\app\Providers;
...
{
    protected string $moduleName      = 'BasicPayment';
    protected string $moduleNamespace = 'Modules\BasicPayment\app\Http\Controllers';
}
