...
Route::group(['as' => 'admin.', 'prefix' => 'admin', 'middleware' => ['auth:admin', 'translation']], function () {
    ...
    // Audit 2026-05-15: pending_withdraw_list() does not exist on the
    // controller. Route was vestigial — removed. The sidebar should link
    // to /admin/withdraw-list?status=pending if a filter view is needed.
