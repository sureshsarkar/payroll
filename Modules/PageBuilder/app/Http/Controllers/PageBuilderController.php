...
class PageBuilderController extends Controller
{
    ...
    {
        // FT-IDOR-7 fix (2026-05-27) — create() was missing the gate
        // that every other method in this class has. The create form
        // is read-only but it's still part of the "page management"
        // surface; gate it to be consistent with index/store/edit/
        // update/destroy/statusUpdate so a sub-admin without
        // `page.management` can't even reach the form.
        checkAdminHasPermissionAndThrowException('page.management');
    ...
    {
        // FT-IDOR-7 fix (2026-05-27) — see create() above.
        checkAdminHasPermissionAndThrowException('page.management');
