...
Route::post('newsletter-request', [NewsLetterController::class, 'newsletter_request'])
    ->middleware('throttle:5,1')
    ->name('newsletter-request');
Route::get('newsletter-verification/{token}', [NewsLetterController::class, 'newsletter_verification'])
