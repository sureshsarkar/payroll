            ...
            <div class="section-body">
                <div class="invoice">
                    <div class="invoice-print">
                        <div class="row ">
                            <div class="col-md-12">
                                <form action="{{ route('admin.subscriptions.update',$subscription->id) }}" method="POST" class="d-print-none">
                                    @csrf
                                    <div class="row "> 
                                        <div class="col-lg-4">
                                            <div class="section-title">{{ __('Name') }}*</div> 
                                            <div class="form-group">
                                                <input name="name" type="text" value="{{ $subscription->name }}"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <input name="price" type="number" value="{{ $subscription->price }}"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <input name="duration_days" type="number" value="{{ $subscription->duration_days }}"
                                                    class="form-control @error('duration_days') is-invalid @enderror" id="role_name"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <input name="description" type="text" value="{{ $subscription->description }}"
