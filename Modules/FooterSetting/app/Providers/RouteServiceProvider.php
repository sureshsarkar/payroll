...
namespace Modules\FooterSetting\app\Providers;
...
{
    protected string $moduleName      = 'FooterSetting';
    protected string $moduleNamespace = 'Modules\FooterSetting\app\Http\Controllers';
}
