                ...
                <div class="mt-4 row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.certificate-section.update', ['code' => $code]) }}" method="post"
                                    ...
                                    <div class="col-md-4 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                        <div class="form-group">
                                           <label>{{ __('Image') }} <br><code>({{ __('Recommended') }}: 370X480 PX)</code></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input data-translate="true" type="text" id="short_title" name="short_title"
                                                value="{{ $certificateSection->getTranslation($code)?->content?->short_title }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input data-translate="true" type="text" id="title" name="title"
                                                value="{{ $certificateSection?->getTranslation($code)?->content?->title }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input data-translate="true" type="text" id="description" name="description"
                                                value="{{ $certificateSection?->getTranslation($code)?->content?->description }}"
    ...
    @if ($code == $languages->first()->code)
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#image-preview').css({
                    'background-image': 'url({{ asset($certificateSection?->global_content?->image) }})',
