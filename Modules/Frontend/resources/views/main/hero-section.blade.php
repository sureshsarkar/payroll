                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="description">{{ __('Description') }}<span
                                                        class="text-danger">*</span></label>
                                                <textarea data-translate="true" name="description" class="summernote_code">{{ $heroSection->getTranslation($code)?->content?->description }}</textarea>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        @if ($code == $languages->first()->code)
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Image') }} <br><code>({{ __('Recommended') }}: 420X460 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background') }} <br><code>({{ __('Recommended') }}: 620X432 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Hero Background') }} <br><code>({{ __('Recommended') }}: 1920X882 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Enrolled students image') }} <br><code>({{ __('Recommended') }}: 155X40 PX)</code></label>
