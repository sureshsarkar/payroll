...
@section('title')
    <title>{{ __('Why Choose Us Section') }}</title>
@endsection
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Why Choose Us Section') }}</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>{{ __('Why Choose Us Section') }}</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.why-choose-us-section.update', ['code' => $code]) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="why_choose_descreption">{{ __('Why Choose Description') }}<span
                                                        class="text-danger">*</span></label>
                                                <textarea data-translate="true" name="why_choose_descreption" class="summernote_code">{{ $ourFeature->getTranslation($code)?->content?->why_choose_descreption??"" }}</textarea>
                                                @error('why_choose_descreption')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
