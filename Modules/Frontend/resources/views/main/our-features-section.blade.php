                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.our-features-section.update', ['code' => $code]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Five') }} <br><code>({{ __('Recommended') }}: 70X70 PX)</code></label>
                                                <div id="image-preview-five" class="image-preview">
                                                    <label for="image-upload"
                                                        id="image-label-five">{{ __('Image') }}</label>
                                                    <input type="file" name="image_five" id="image-upload-five">
                                                </div>
                                                @error('image_five')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="">{{ __('Title Five') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="title"
                                                    name="title_five"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->title_five }}"
                                                    placeholder="{{ __('Enter Title Five') }}" class="form-control">
                                                @error('title_five')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label for="">{{ __('Sub Title five') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="sub_title"
                                                    name="sub_title_five"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->sub_title_five }}"
                                                    placeholder="{{ __('Enter Sub Title') }}" class="form-control">
                                                @error('sub_title_five')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Six') }} <br><code>({{ __('Recommended') }}: 70X70 PX)</code></label>
                                                <div id="image-preview-six" class="image-preview">
                                                    <label for="image-upload"
                                                        id="image-label-six">{{ __('Image') }}</label>
                                                    <input type="file" name="image_six" id="image-upload-six">
                                                </div>
                                                @error('image_six')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="">{{ __('Title Six') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="title"
                                                    name="title_six"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->title_six }}"
                                                    placeholder="{{ __('Enter Title Six') }}" class="form-control">
                                                @error('title_six')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label for="">{{ __('Sub Title six') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="sub_title"
                                                    name="sub_title_six"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->sub_title_six }}"
                                                    placeholder="{{ __('Enter Sub Title') }}" class="form-control">
                                                @error('sub_title_six')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                    ...
                                    <div class="row">
                                         <div class="col-md-2 {{ $code == $languages->first()->code ? '' : 'd-none' }}">
                                            <div class="form-group">
                                                <label>{{ __('Image Seven') }} <br><code>({{ __('Recommended') }}: 70X70 PX)</code></label>
                                                <div id="image-preview-seven" class="image-preview">
                                                    <label for="image-upload"
                                                        id="image-label-seven">{{ __('Image') }}</label>
                                                    <input type="file" name="image_seven" id="image-upload-seven">
                                                </div>
                                                @error('image_seven')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                         ...
                                         <div class="col-md-10">
                                            <div class="form-group">
                                                <label for="">{{ __('Title Seven') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="title"
                                                    name="title_seven"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->title_seven }}"
                                                    placeholder="{{ __('Enter Title Seven') }}" class="form-control">
                                                @error('title_seven')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label for="">{{ __('Sub Title seven') }}<span
                                                        class="text-danger">*</span></label>
                                                <input data-translate="true" type="text" id="sub_title"
                                                    name="sub_title_seven"
                                                    value="{{ $ourFeature?->getTranslation($code)?->content?->sub_title_seven }}"
                                                    placeholder="{{ __('Enter Sub Title') }}" class="form-control">
                                                @error('sub_title_seven')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
    ...
    @if ($code == $languages->first()->code)
        ...
        <script>
            $(document).ready(function() {
                ...
                $.uploadPreview({
                    input_field: "#image-upload-five",
                    preview_box: "#image-preview-five",
                    label_field: "#image-label-five",
                    label_default: "{{ __('Choose Icon') }}",
                    label_selected: "{{ __('Change Icon') }}",
                    no_label: false,
                    success_callback: null
                ...
                $('#image-preview-five').css({
                    'background-image': 'url({{ asset($ourFeature?->global_content?->image_five) }})',
                    'background-size': 'contain',
                    'background-position': 'center',
                    'background-repeat': 'no-repeat'
                });
                ...
                $.uploadPreview({
                    input_field: "#image-upload-six",
                    preview_box: "#image-preview-six",
                    label_field: "#image-label-six",
                    label_default: "{{ __('Choose Icon') }}",
                    label_selected: "{{ __('Change Icon') }}",
                    no_label: false,
                    success_callback: null
                ...
                $('#image-preview-six').css({
                    'background-image': 'url({{ asset($ourFeature?->global_content?->image_six) }})',
                    'background-size': 'contain',
                    'background-position': 'center',
                    'background-repeat': 'no-repeat'
                });
                ...
                $.uploadPreview({
                    input_field: "#image-upload-seven",
                    preview_box: "#image-preview-seven",
                    label_field: "#image-label-seven",
                    label_default: "{{ __('Choose Icon') }}",
                    label_selected: "{{ __('Change Icon') }}",
                    no_label: false,
                    success_callback: null
                ...
                $('#image-preview-seven').css({
                    'background-image': 'url({{ asset($ourFeature?->global_content?->image_seven) }})',
                    'background-size': 'contain',
                    'background-position': 'center',
                    'background-repeat': 'no-repeat'
                });
