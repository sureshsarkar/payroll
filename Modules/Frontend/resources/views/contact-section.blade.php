                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.contact-section.update', 1) }}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input data-translate="true" type="text" id="title" name="address"
                                                    value="{{ $contact?->address }}" placeholder="{{ __('Address') }}"
                                                    class="form-control">
                                                @error('address')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">{{ __('Phone One') }}<span
                                                        class="text-danger"></span></label>
                                                <input data-translate="true" type="text" id="phone_one" name="phone_one"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">{{ __('Timing') }}<span
                                                        class="text-danger"></span></label>
                                                <input data-translate="true" type="text" id="timing" name="timing"
                                                    value="{{ $contact?->timing }}" placeholder="{{ __('Timing') }}"
                                                    class="form-control">
                                                @error('timing')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
