    ...
    <li
        ...
        <ul class="dropdown-menu">
            ...
            @endtheme
                ...
                <li class="{{ isRoute('admin.certificate-section.*', 'active') }}">
                    <a class="nav-link" href="{{ route('admin.certificate-section.index', ['code' => 'en']) }}">
                        {{ __('Certificate Section') }}
                    </a>
                </li>
            ...
            <li class="{{ isRoute('admin.why-choose-us-section.*', 'active') }}">
                <a class="nav-link"
                    href="{{ route('admin.why-choose-us-section.index', ['code' => 'en']) }}">
