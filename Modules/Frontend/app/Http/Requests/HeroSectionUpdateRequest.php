...
class HeroSectionUpdateRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'banner_background'     => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'banner_background_two' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'hero_background'       => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'enroll_students_image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
        ];
    }
