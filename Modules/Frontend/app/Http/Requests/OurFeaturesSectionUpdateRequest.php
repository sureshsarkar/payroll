...
class OurFeaturesSectionUpdateRequest extends FormRequest {
    ...
    public function rules(): array {
        $rules = [
            ...
            'image_four'      => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'title_four'      => ['sometimes', 'string', 'max:255'],
            'sub_title_four'  => ['sometimes', 'string', 'max:255'],

            'image_five'      => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'title_five'      => ['sometimes', 'string', 'max:255'],
            'sub_title_five'  => ['sometimes', 'string', 'max:255'],

            'image_six'      => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'title_six'      => ['sometimes', 'string', 'max:255'],
            'sub_title_six'  => ['sometimes', 'string', 'max:255'],

            'image_seven'      => ['nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:2048'],
            'title_seven'      => ['sometimes', 'string', 'max:255'],
            'sub_title_seven'  => ['sometimes', 'string', 'max:255'],
        ];
    ...
    function messages(): array {
        ...
        return [
            ...
            'image_five.nullable'      => __('The image five must be a file.'),
            'image_five.image'         => __('The image five must be an image.'),
            'image_five.max'           => __('The image five may not be greater than 2048 kilobytes.'),
            'title_five.required'      => __('The title five field is required.'),
            'title_five.string'        => __('The title five must be a string.'),
            'title_five.max'           => __('The title five may not be greater than 255 characters.'),
            'sub_title_five.required'  => __('The sub title five field is required.'),
            'sub_title_five.string'    => __('The sub title five must be a string.'),
            'sub_title_five.max'       => __('The sub title five may not be greater than 255 characters.'),

            'image_six.nullable'      => __('The image six must be a file.'),
            'image_six.image'         => __('The image six must be an image.'),
            'image_six.max'           => __('The image six may not be greater than 2048 kilobytes.'),
            'title_six.required'      => __('The title six field is required.'),
            'title_six.string'        => __('The title six must be a string.'),
            'title_six.max'           => __('The title six may not be greater than 255 characters.'),
            'sub_title_six.required'  => __('The sub title six field is required.'),
            'sub_title_six.string'    => __('The sub title six must be a string.'),
            'sub_title_six.max'       => __('The sub title six may not be greater than 255 characters.'),

            'image_seven.nullable'      => __('The image seven must be a file.'),
            'image_seven.image'         => __('The image seven must be an image.'),
            'image_seven.max'           => __('The image seven may not be greater than 2048 kilobytes.'),
            'title_seven.required'      => __('The title seven field is required.'),
            'title_seven.string'        => __('The title seven must be a string.'),
            'title_seven.max'           => __('The title seven may not be greater than 255 characters.'),
            'sub_title_seven.required'  => __('The sub title seven field is required.'),
            'sub_title_seven.string'    => __('The sub title seven must be a string.'),
            'sub_title_seven.max'       => __('The sub title seven may not be greater than 255 characters.'),
        ];
    }
}
