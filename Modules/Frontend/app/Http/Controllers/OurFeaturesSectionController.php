...
class OurFeaturesSectionController extends Controller {
    ...
    public function update(OurFeaturesSectionUpdateRequest $request) {
        ...
        $global_content = $this->updateSectionContent($section?->global_content, $request, ['button_url_one','button_url_two' ,'button_url_three','button_url_four'], ['image_one', 'image_two', 'image_three', 'image_four','image_five','image_six','image_seven']);

        // Update translated content
        $content = $this->updateSectionContent($section?->content, $request, ['sec_title','sec_description','title_one', 'sub_title_one', 'title_two', 'sub_title_two', 'title_three', 'sub_title_three', 'title_four', 'sub_title_four','title_five', 'sub_title_five','title_six', 'sub_title_six','title_seven', 'sub_title_seven']);
