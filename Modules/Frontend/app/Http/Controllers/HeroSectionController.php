...
class HeroSectionController extends Controller
{
    ...
    public function update(HeroSectionUpdateRequest $request)
    {
        ...
        $global_content = $this->updateSectionContent($section?->global_content, $request, ['action_button_url', 'video_button_url', 'booking_number'], ['banner_image', 'banner_background', 'hero_background', 'enroll_students_image']);

        // Update translated content
        $content = $this->updateSectionContent($section?->content, $request, ['short_title', 'title', 'sub_title', 'description', 'total_student', 'total_instructor', 'total_courses', 'average_reviews', 'video_button_text', 'action_button_text']);
