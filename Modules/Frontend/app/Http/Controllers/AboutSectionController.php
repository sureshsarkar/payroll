...
class AboutSectionController extends Controller {
    ...
    public function update(AboutSectionUpdateRequest $request) {
        ...
        $global_content = $this->updateSectionContent($section?->global_content, $request, ['button_url', 'video_url', 'year_experience', 'course_success', 'phone_number'], ['image','banner_image', 'about_image', 'our_mission_image']);

        // Update translated content
        $content = $this->updateSectionContent($section?->content, $request, ['short_title', 'title', 'description','our_courses_description','our_mission_about_page_description', 'about_page_description','terms_and_conditions_page_description','privacy_policy_page_description','button_text']);
