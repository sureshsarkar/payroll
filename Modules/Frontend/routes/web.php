...
use Modules\Frontend\app\Http\Controllers\CertificateSectionController;
...
use Modules\Frontend\app\Http\Controllers\WhyChooseUsSectionController;
...
Route::group(['middleware' => 'auth:admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('why-choose-us-section', [WhyChooseUsSectionController::class, 'index'])->name('why-choose-us-section.index');
    ...
    Route::get('certificate-section', [CertificateSectionController::class, 'index'])->name('certificate-section.index');
    Route::put('certificate-section', [CertificateSectionController::class, 'update'])->name('certificate-section.update');
