                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4>Order List</h4>
                                <div>
                                    <a href="{{ route('admin.orders.create')}}" class="btn btn-primary"> <i class="fa fa-plus"></i>Add New</a>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @forelse ($orders as $index => $order)
                                            <tr>
                                                <td>{{ ++$index }}</td>
                                                <td>
                                                    {{-- 2026-06-02 (E2E) — null-guard the customer link. Some
                                                         orders carry a NULL buyer_id (legacy gift/coach_manual
                                                         rows); route('admin.customer-show', null) throws a
                                                         UrlGenerationException and 500s the whole listing. Link
                                                         only when a buyer exists, else show the name (or a dash). --}}
                                                    @if($order->buyer_id)
