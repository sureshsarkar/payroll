...
class CourseStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            // 2026-06-02 — cap price/discount at a sane max (matches the API
            // course rules, CoachDashboardController). Without an upper bound a
            // course could be saved with an absurd price (e.g. 99,999,999,999),
            // which then flows straight into orders/invoices as the amount.
            'price' => ['required', 'numeric', 'min:0', 'max:9999999'],
            'discount_price' => ['nullable', 'numeric', 'min:0', 'max:9999999', new ValidateDiscountRule()],
    ...
    function messages(): array
    {
        return [
            ...
            'price.max' => __('Price is too large (maximum :max).', ['max' => '9,999,999']),
            'discount.numeric' => __('Discount must be a number'),
            'discount_price.max' => __('Discount is too large (maximum :max).', ['max' => '9,999,999']),
