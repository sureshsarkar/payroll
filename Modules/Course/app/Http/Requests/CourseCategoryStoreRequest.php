...
class CourseCategoryStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // FT-UPLOAD-3 (2026-05-28) — explicit mimes + size cap.
            // Category icons render on the public course catalogue.
    ...
    function messages(): array
    {
        return [
            ...
            'show_at_trending.required' => __('The show at trending field is required'),
        ];
    }
}
