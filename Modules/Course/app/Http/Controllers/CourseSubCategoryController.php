...
class CourseSubCategoryController extends Controller
{
    ...
    /**
     * FT-IDOR-5 fix (2026-05-27) — see CourseCategoryController.
     * All public methods mutate admin-side taxonomy; gate them all
     * via constructor middleware on `course.management`.
     */
