...
class CourseLanguageController extends Controller
{
    ...
    /**
     * FT-IDOR-5 fix (2026-05-27) — every public method here mutates
     * admin-side taxonomy but the controller had NO permission gates.
     * Gate on `course.management` consistent with CourseController and
     * the rest of the Course module. See CourseCategoryController for
     * the full rationale.
     */
