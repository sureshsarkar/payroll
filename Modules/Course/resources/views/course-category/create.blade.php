            ...
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active"><a
                            href="{{ route('admin.course-category.index') }}">{{ __('Course Category List') }}</a>
                    </div>
                                ...
                                <form action="{{ route('admin.course-category.store') }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="offset-md-2 col-md-8">
                                            <div class="form-group">
                                                <label>{{ __('Icon') }} <code>* ({{ __('Recommended') }}: 64X64 PX)</code></label>
                                        ...
                                        <div class="offset-md-2 col-md-8">
                                            <div class="form-group">
                                                <label for="description">{{ __('Description') }}<span
                                                        class="text-danger">*</span></label>
                                                <textarea data-translate="true" name="description" class="summernote">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
