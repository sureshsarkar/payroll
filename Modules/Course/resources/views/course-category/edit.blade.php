...
@section('title')
    <title>{{ __('Course Category') }}</title>
@endsection
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('Course Update') }}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a>
                    </div>
                    <div class="breadcrumb-item active"><a
                            href="{{ route('admin.course-category.index') }}">{{ __('Category List') }}</a>
                    </div>
                    <div class="breadcrumb-item">{{ __('Category update') }} ({{ request('code') }})</div>
                </div>
            </div>
                                ...
                                <ul class="lang_list">
                                    @foreach ($languages as $language)
                                        <li><a id="{{ request('code') == $language->code ? 'selected-language' : '' }}"
                                                href="{{ route('admin.course-category.edit', ['course_category' => $category->id, 'code' => $language->code]) }}"><i
                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($code == $languages->first()->code)
                                            ...
                                            <div class="offset-md-2 col-md-8">
                                                <div class="form-group">
                                                    <label for="description">{{ __('Description') }}<span
                                                            class="text-danger">*</span></label>
                                                    <textarea data-translate="true" name="description" class="summernote">{{ old('description',$category->description) }}</textarea>
                                                    @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="offset-md-2 col-md-8">
                                                <div class="form-group">
                                                    <label>{{ __('Icon') }} <code>({{ __('Recommended') }}: 64X64
                                                            PX)</code></label>
                                        ...
                                        <div
                                            ...
                                            <div class="form-group">
                                                <label for="status">{{ __('Show at Trending') }}<span
                                                        class="text-danger">*</span></label>
