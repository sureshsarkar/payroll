@if (Module::isEnabled('Language') && Route::has('admin.course.index'))
    ...
    <li
        ...
        <ul class="dropdown-menu">
            ...
            {{-- 2026-05-29 Doc-A3: Languages + Levels sidebar items removed
                 per product feedback (taxonomy not in active use; the More
                 Info wizard step also no longer exposes the UI per Doc-A2).
                 Routes + controllers + views remain registered so that the
                 helper.php settings menu entries continue to resolve. If
                 you need to restore the sidebar items, copy the two <li>
                 blocks from git history before this commit. --}}
