        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Course Level List') }}</div>
                </div>
            </div>
                                                    ...
                                                    <td class="text-center">
                                                        <div>
                                                            <a href="{{ route('admin.course-level.edit', [
                                                                ...
                                                                title="{{ __('Edit') }}"
                                                                aria-label="{{ __('Edit course level') }}">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <a href="javascript:;" data-toggle="modal"
                                                                data-target="#deleteModal" class="btn btn-danger btn-sm"
                                                                onclick="deleteData({{ $level->id }})"
                                                                title="{{ __('Delete') }}"
                                                                aria-label="{{ __('Delete course level') }}"><i
                                                                    class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @empty
                                                <x-empty-table :name="__('Level')" route="admin.course-level.create"
