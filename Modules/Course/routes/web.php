...
Route::group(['middleware' => ['auth:admin', 'translation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    /** review controller */
    // Audit 2026-05-15: CourseReviewController has only {index, show,
    // update, destroy} — reviews are user-generated, no admin /create form.
    Route::resource('course-review', CourseReviewController::class)
        ->only(['index', 'show', 'update', 'destroy']);

    /** course delete request */
    // Audit 2026-05-15: CourseDeleteRequestController has only {index,
    // update}. Delete requests are submitted by instructors, not admins.
