...
class SendBulkEmailToUser implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($this->user_type == 'all_user') {
            // F52 (audit 2026-06-26) — chunk instead of loading the entire user
            // base into memory with ->get(). Each send is individually guarded so
            // one bad address can't abort the batch.
