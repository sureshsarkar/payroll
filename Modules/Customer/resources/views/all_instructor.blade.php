            ...
            <div class="section-body">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admin.all-instructors') }}" method="GET"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="mb-0">{{ __('All Instructors') }}
                                    @if (method_exists($users, 'total'))
                                        <span class="badge badge-light ml-1" style="font-weight:600;">{{ number_format($users->total()) }}</span>
                                    @endif
                                </h4>
                                <div class="d-flex" style="gap:8px;">
                                    {{-- 2026-06-25 — CSV export honouring the active filters --}}
                                    <a href="{{ route('admin.instructors.export', request()->only(['keyword', 'verified', 'banned'])) }}"
                                        class="btn btn-outline-primary"><i class="fas fa-file-csv"></i> {{ __('Export') }}</a>
                                    @adminCan('customer.create')
                                        <a href="{{ route('admin.create-instructor') }}" class="btn btn-primary"><i
