...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            // Audit fix: was hardcoded 'your@example.com' — backup-failure
            // notifications would silently disappear into the void on any
            // fresh install that forgot to update this string. Now reads
            // BACKUP_NOTIFY_EMAIL env, falling back through MAIL_FROM_ADDRESS
            // to a placeholder valid-email so package:discover doesn't choke
            // on empty values. Using `?:` rather than env() default arg
            // because env('FOO') with FOO= (empty) returns "" not null,
            // and Spatie\Backup parses 'to' at config-load and rejects
            // the empty string as "not a valid email".
