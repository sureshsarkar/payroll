...
return [
    ...
    */
    'cache' => [
        // Enabled 2026-05-05 (audit perf pass). Without this, every HTTP
        // request re-scans the Modules/ directory and reads every module.json
        // and composer.json — measured at hundreds of ms on Windows.
        // Use `php artisan modules:cache` to rebuild after enabling/disabling
        // a module, OR clear via `php artisan cache:clear`.
        'enabled' => true,
        'driver'  => env('CACHE_DRIVER', 'database'),
        'key'     => 'laravel-modules',
        'lifetime' => 86400, // 24h — modules don't change at runtime in prod
    ],
    /*
    |--------------------------------------------------------------------------
