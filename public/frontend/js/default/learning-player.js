...
const baseUri = document.querySelector('meta[name="main-base-url"]').getAttribute('content');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (
                    ...
                    if (file_info.storage == "upload") {
                        ...
                        <div class="file-info">
                            <div class="text-center">
                                <img src="${baseUri}/uploads/website-images/resource-file.png" alt="">
                                <h6>${resource_text}</h6>
                                <p>${file_type_text}: ${file_info.file_type}</p>
                                <p>${download_des_text}</p>
                                <form action="${baseUri}/student/learning/resource-download/${file_info.id}" method="get" class="download-form">
                    ...
                    <div class="file-info">
                        <div class="text-center">
                            <img src="${baseUri}/uploads/website-images/quiz.png" alt="">
                            <h6 class="mt-2">${file_info.title}</h6>
                            <p>${quiz_st_des_txt}</p>
                            <a href="${baseUri}/student/learning/quiz/${file_info.id}" class="btn btn-primary">${quiz_st_txt}</a>
                        </div>
                    </div>
                </div>`;
                }
